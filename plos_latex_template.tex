...
\emph{Stem diameter:} Plastid membrane lipids ranked highest, led by SQDG(18{:}3/18{:}3), with DGDG(16{:}0/18{:}1) also prominent; growth‐related signals such as gibberellic acid and the oxylipin 9,12,13‐TriHODE appeared among the top features, alongside PA(16{:}0/18{:}2) and several medium/long‐chain TGs. This points to a link between plastid anionic/galactolipid remodeling, oxylipin signaling, and stem thickening.\\
\emph{β‐Carotene:} The panel was topped by carotenoid and apocarotenoid markers (β‐carotene itself and apocarotenal), with multiple PUFA‐rich TGs and very‐long‐chain PCs (e.g., PC(18{:}1/24{:}0)) among the best predictors, consistent with carotenoid metabolism and neutral‐lipid packaging.\\
\emph{Lutein:} Lutein was the top predictor, as expected, with zeaxanthin, apocarotenal, and PC(18{:}1/18{:}1) close behind; several TGs (e.g., TG(12{:}0/18{:}1/18{:}1)) also scored high, suggesting that both carotenoid abundance and storage‐lipid context inform the signal.\\
\emph{Zeaxanthin:} Zeaxanthin‐related chemistry surfaced via antheraxanthin (xanthophyll cycle) among the top features, together with a series of PUFA‐rich TGs and DG(16{:}0/16{:}0), again indicating a coupling between xanthophyll levels and neutral‐lipid buffering.\\
\emph{Grain number per primary panicle:} High‐ranking predictors were long‐chain TGs (e.g., TG(16{:}0/18{:}1/22{:}0), TG(18{:}0/18{:}2/22{:}0)) and MG(20{:}4), together with the carotenoid‐derived volatile \emph{$\alpha$}‐ionone and structural PCs (and CL(18{:}1)), pointing to a nexus of reserve lipids, carotenoid cleavage products, and membrane composition with reproductive output.\\
\emph{Thousand‐grain weight:} Membrane phospholipids led (PC(18{:}1/20{:}4) top), with MG(18{:}2) and LPE(16{:}0) highlighting lysophospholipid editing; antioxidant/apocarotenoid markers (e.g., apocarotenal, ubiquinone, \emph{$\alpha$}‐tocopherol) also featured, suggesting grain mass tracks both phospholipid remodeling and redox‐active isoprenoids.\\
\emph{Grain yield per primary panicle:} The carotenoid‐derived volatile \textbf{\emph{$\alpha$}‐ionone} was the top predictor, followed by PE/LPE species (PE(16{:}0/0{:}0), LPE(16{:}0)), MG(20{:}4), TG(18{:}0/18{:}2/22{:}0), and DGDG(18{:}0/18{:}3), indicating joint contributions from carotenoid turnover, phospho/galactolipid state, and storage lipids to yield.
