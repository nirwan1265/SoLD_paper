...
%========================================================
%  Supplementary Figure S1   (panels A, B, C)
%========================================================
\begin{figure}[htp]
  \centering
  ...
  \begin{subfigure}[t]{0.48\textwidth}
    \includegraphics[width=\linewidth]{fig/supp/SuppFig_1A_Lipid_Counts}
    \caption{Number of lipid \textit{species}.}
    \label{fig:S1A}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \includegraphics[width=\linewidth]{fig/supp/SuppFig_1B_Lipid_Class_Counts}
  ...
  \begin{subfigure}[t]{0.55\textwidth}
    \centering
    \includegraphics[width=\linewidth]{fig/supp/SuppFig_1C_Lipid_Overlap_Venn}
