...
\begin{figure}[htp]
  \centering
  %----------------------------------------------------
  %  (A) Top left: species‐level lipid composition
  %----------------------------------------------------
  ...
  \hfill
  %----------------------------------------------------
  %  (B) Top right: class‐level lipid composition
  %----------------------------------------------------
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
  ...
  \caption{%
    ...
    (C) PCA biplot of individual lipid species, with scores colored by condition and vectors showing species loadings.  
