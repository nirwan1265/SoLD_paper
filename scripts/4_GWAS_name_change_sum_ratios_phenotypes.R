...
control  <- vroom("data/SPATS_fitted/BLUP_GWAS_phenotype/Final_control_all_lipids_BLUPs.csv")
colnames(control)[1] <- "Compound_Name"  

lowinput  <- vroom("data/SPATS_fitted/BLUP_GWAS_phenotype/Final_lowinput_all_lipids_BLUPs.csv")
